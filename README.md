...
If you are using [React hooks](https://reactjs.org/docs/hooks-intro.html) with latest React 16.7 have a look at a future proof project [mobx-react-lite](https://github.com/mobxjs/mobx-react-lite).
