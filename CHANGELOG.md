...
-   `observer` components no longer fire `componentDidUpdate` lifecycle method based on observable change ([see more](https://github.com/mobxjs/mobx-react/blob/master/README.md#user-content-lifecycle-method-componentdidupdate-not-firing)).
