var mobservable = typeof mobservable !== "undefined" ? mobservable : require('mobservable');
...
(function() {
    ...
    var renderReporter; // Simple event emitter
    var componentByNodeRegistery; // WeakMap<Node, Object>;
    ...
    function patch(target, funcName) {
        ...
        var mixinFunc = reactiveComponent[funcName];
    ...
    function reactiveComponent(componentClass) {
        ...
        if (!target.shouldComponentUpdate)
            target.shouldComponentUpdate = reactiveComponent.shouldComponentUpdate;
    ...
    function trackComponents() {
        ...
        if (!isTracking) {
            componentByNodeRegistery = new WeakMap();
            renderReporter = new _.SimpleEventEmitter();
            isTracking = true;
        }
    }
    ...
    if (typeof define === 'function' && define.amd)
        throw new Error("AMD loading is not supported yet, please file an issue if this is needed. https://github.com/mweststrate/mobservable/issues");
    else if (typeof exports === 'object')
        module.exports = api;
    else
        this.mobservableReact = api;
})();
